...
export class LoginComponent implements OnInit {
  ...
  logIn() {
    try {
      ...
      Swal.showLoading();
      this.authSrv.login(this.signInForm.controls.email.value, this.signInForm.controls.password.value)
  ...
  recoverPassword() {
    try {
      ...
      Swal.showLoading();
      this.authSrv.forgotPasswordRequest(this.passwordRecoveyForm.controls.email.value)
        .subscribe((observer: ServiceResultInterface) => {
          swal.close();
          if (observer.code !== 'success') {
